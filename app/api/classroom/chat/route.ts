    ...
    const response = await fetch("https://api.openai.com/v1/responses", {
      ...
      body: JSON.stringify({
        ...
        instructions: [
          ...
          "Explain and discuss the ideas on the current slide in your own words — never read bullet points or slide text verbatim.",
          "Treat speaker notes as private instructor context; the learner sees the slide image, not your notes.",
          ...
          "Keep presentation.type slide while teaching so the PowerPoint slide stays visible.",
          "Do not repeat on-screen slide text — the learner can already see it.",
