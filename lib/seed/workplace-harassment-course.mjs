...
const harassmentSections = [
  {
    ...
    lessonPlan: {
      ...
      opening:
        "Start here. This example course demonstrates every Mason teaching format in one walkthrough—explain, text, tiles, visual, drag-to-order, scenario, question, and summary. Each block below is labeled so you can see exactly what learners experience.",
      objectives: [
      ...
      moments: [
        ...
        question(
          "Question moment",
          "Knowledge checks confirm understanding before learners move on.",
          "Which statement about workplace policy is most accurate?",
          [
            "Policy only applies after a legal violation",
            "Policy may require action before conduct becomes unlawful",
            "Only managers can raise concerns",
            "A single incident never matters",
          ],
          1,
          "Correct. Strong workplace policies often support early intervention.",
        ),
        summary(
          "Summary moment",
