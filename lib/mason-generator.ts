  ...
  const response = await fetch("https://api.openai.com/v1/responses", {
    ...
    body: JSON.stringify({
      ...
      instructions: [
        ...
        "Create two or three learn-phase narrated picture flipbooks from the source PDF. Each visual moment walks the learner through a diagram, chart, photo, or labeled illustration on a specific PDF page.",
        "Every visual moment must set explainerStyle to flipbook and provide 3 to 5 explainerFrames that pan across different regions of the same source page.",
        "Each explainer frame needs a short title, one-sentence visible caption, natural spoken narration (2 to 4 conversational sentences), and 1 to 3 concise visual labels. Frames must teach a coherent mini-lesson by moving the learner's eye across the source picture.",
        "For each explainer frame, set focusX and focusY (0-100) to the center of what the learner should look at on the source PDF page, and focusScale (1.2-2.2) for how tightly to zoom that region. Vary focus coordinates across frames so the flipbook visibly moves across the picture.",
        "Also set visualType and provide 3 to 6 concise visualItems as a summary of the entire explainer.",
        "For every visual, set pageNumber to the PDF page containing the most useful supporting picture, diagram, chart, or example. The learner will see that page as a picture flipbook, so narration must describe what to notice in each zoomed region.",
